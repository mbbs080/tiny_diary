    ...
    <div class="flex item-center justify-center mt-7">
        <form action="/users" method="POST" class="px-2">
            ...
            <div class="flex flex-col">
                <input placeholder="name" class="bg-slate-100 px-2 mt-2 p-1 rounded-md p-1 focus:outline-none" type="text"
            ...
            <div class="flex flex-col">
                <input placeholder="email" class="bg-slate-100 px-2 mt-2 p-1 rounded-md p-1 focus:outline-none"
